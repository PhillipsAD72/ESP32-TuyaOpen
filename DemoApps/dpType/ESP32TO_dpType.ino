...
// button (na Devkit V1 je led připojena na GPIO2 a tlačítko na GPIO0.
//         Ale vestavěné tlačítko vyvolá reset MCU, takže jsem připojil vlastní tlačítko na GPIO13)

#define buttonPin         13   // GPIO13 | BUTTON_BUILTIN = GPIO35
#define LED               2    // GPIO2  | LED_BUILTIN = GPIO33
...
// Tuya license (NAHRAĎTE UUID A AUTHKEY ZÍSKANÝMI OD TUYAOPEN)
#define TUYA_DEVICE_UUID    "uuid####"
#define TUYA_DEVICE_AUTHKEY "********"
